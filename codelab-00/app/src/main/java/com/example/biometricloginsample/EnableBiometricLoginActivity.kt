...
import com.example.biometricloginsample.databinding.ActivityEnableBiiometricLoginBinding
...
class EnableBiometricLoginActivity: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val binding = ActivityEnableBiiometricLoginBinding.inflate(layoutInflater)
